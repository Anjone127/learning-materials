...
import anjone.myunit.annontation.Test;
import anjone.myunit.annontation.TestObjectCleanup;
import anjone.myunit.annontation.TestObjectCreate;
 ...
 * @since 2020/05/19
 */
public class MyUnit implements ProcessFiles.Strategy {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new ProcessFiles(new MyUnit(), "class").start(args);
        if (failures == 0) {
